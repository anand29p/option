...
KITE_TOKEN_FILE = ".kite_access_token"     # Cached daily token

# ── Capital & Risk ────────────────────────────────────────────────────────────
PAPER_CAPITAL           = 20_000.0   # ₹ Total virtual capital
MAX_CAPITAL_PER_TRADE   = 3_000.0   # ₹ Max premium outlay per trade
